...
from .const import (
	...
	DEFAULT_CONFIGURATION_QUIETEN_EXPECTED_WARNINGS,
	DEFAULT_CONFIGURATION_VERBOSE_CONNECTION_LOGGING
)
			...
			data_schema=vol.Schema(
				{
					...
					vol.Optional(
						CONFIGURATION_QUIETEN_EXPECTED_WARNINGS,
						default=self._config_entry.options.get(CONFIGURATION_QUIETEN_EXPECTED_WARNINGS, DEFAULT_CONFIGURATION_QUIETEN_EXPECTED_WARNINGS),
					): bool,
					vol.Optional(
						CONFIGURATION_VERBOSE_CONNECTION_LOGGING,
						default=self._config_entry.options.get(CONFIGURATION_VERBOSE_CONNECTION_LOGGING, DEFAULT_CONFIGURATION_VERBOSE_CONNECTION_LOGGING),
					): bool,
				}
			),
		)  
